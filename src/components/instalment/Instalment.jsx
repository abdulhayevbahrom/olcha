        ...
        <div className="right">
          <div className="product_item">
            <div className="img_div">
              <img
                src="https://olcha.uz/image/220x220/products/cdn_1/supplier/stores/1/2024-06-24/W8coPWYRzc6yR0iXSnaUL6vKxv7MRkF4KCCrYCk9672yfFt350bsGHH62atj.JPG"
                alt="telefon_img"
              />
            </div>
            <div className="data">
              <p className="title">
                Xiaomi Redmi note 13 <br /> Midnight Black 6/128 GB
              </p>
